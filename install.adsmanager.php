...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            If you are doing an update, you need to save the configuration at least once to avoid any error that may be caused by missing new settings.
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <a href="index.php?option=com_adsmanager&c=configuration" class="btn btn-primary">
                Configuration
            </a>
        </div>
    </div>
...
<?php
	...
	$db->setQuery("CREATE TABLE IF NOT EXISTS `#__adsmanager_searchpage_config` (
			`id` int(11) NOT NULL AUTO_INCREMENT,
			`params` text NOT NULL,
			PRIMARY KEY  (`id`)
	);");
	...
	$db->setQuery("INSERT IGNORE INTO `#__adsmanager_searchpage_config` (`params`) VALUES ('')");
	try {
		$result = $db->query();
	} catch(Exception $e) {
	...
	if ($total == 0)
	{
		...
		$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `name` TEXT DEFAULT NULL;";
		$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `ad_zip` TEXT DEFAULT NULL;";
		$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `ad_city` TEXT DEFAULT NULL;";
		$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `ad_phone` TEXT DEFAULT NULL;";
		$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `email` TEXT DEFAULT NULL;";
		$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `ad_kindof` TEXT DEFAULT NULL;";
		$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `ad_headline` TEXT DEFAULT NULL;";
		$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `ad_text` TEXT DEFAULT NULL;";
		$queries[] = " ALTER TABLE `#__adsmanager_ads` CHANGE `ad_state` `ad_state` TEXT DEFAULT NULL;";
		$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `ad_price` TEXT DEFAULT NULL;";
		$queries[] = "ALTER TABLE `#__adsmanager_profile` ADD `name` TEXT DEFAULT NULL;";
		$queries[] = "ALTER TABLE  `#__adsmanager_profile` ADD `ad_zip` TEXT DEFAULT NULL;";
		$queries[] = "ALTER TABLE `#__adsmanager_profile` ADD `ad_city` TEXT DEFAULT NULL;";
		$queries[] = "ALTER TABLE `#__adsmanager_profile` ADD `ad_phone` TEXT NOT NULL;";
	...
	$queries[] = "ALTER TABLE `#__adsmanager_fields` CHANGE `catsid` `catsid` TEXT NOT NULL;";
	$queries[] = "ALTER TABLE `#__adsmanager_columns` CHANGE `catsid` `catsid` TEXT NOT NULL;";
	$queries[] = "ALTER TABLE `#__adsmanager_ads` CHANGE `date_created` `date_created` DATETIME NOT NULL;";
	$queries[] = "ALTER TABLE  `#__adsmanager_config` ADD `bannedwords` TEXT DEFAULT NULL;";
	$queries[] = "ALTER TABLE  `#__adsmanager_config` ADD `replaceword` TEXT DEFAULT NULL;";
	$queries[] = "ALTER TABLE  `#__adsmanager_config` ADD `after_expiration` TEXT DEFAULT NULL;";
	$queries[] = "ALTER TABLE  `#__adsmanager_config` ADD `archive_catid` INT(10) NOT NULL default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `metadata_description` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_ads` ADD `metadata_keywords` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_categories` ADD `metadata_description` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_categories` ADD `metadata_keywords` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `metadata_mode` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `autocomplete` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `jquery` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `jqueryui` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `nb_last_cols` int(10) NOT NULL default '3';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `nb_last_rows` int(10) NOT NULL default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `display_general_menu` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `display_list_sort` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `display_list_search` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `display_inner_pathway` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `display_front` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `send_email_on_new_to_user` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `send_email_on_update_to_user` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `send_email_on_validation_to_user` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `send_email_on_expiration_to_user` tinyint(1) default '1';";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `new_text` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `update_text` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `admin_new_text` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `admin_update_text` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `waiting_validation_text` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `validation_text` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `expiration_text` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `new_subject` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `update_subject` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `admin_new_subject` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `admin_update_subject` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `waiting_validation_subject` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `validation_subject` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `expiration_subject` TEXT DEFAULT NULL;";
	$queries[] = " ALTER TABLE `#__adsmanager_config` ADD `recall_subject` TEXT DEFAULT NULL;";
    ...
    $queries = array();
    $queries[] = "ALTER TABLE `#__adsmanager_config` MODIFY `show_contact` TEXT NULL;";
	...
	$db->setQuery("ALTER TABLE `#__adsmanager_ads` ADD `images` TEXT;");
	try {
		$result = $db->query();
	} catch(Exception $e) {
	...
	$db->setQuery("CREATE TABLE IF NOT EXISTS  `#__adsmanager_alerts` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
	...
	if ($config == null) {
		$sql = (" INSERT IGNORE INTO `#__adsmanager_config` (`id`,`version`,`ads_per_page`,`max_image_size`,`max_width`,`max_height`,`max_width_t`,`max_height_t`,`root_allowed`,`nb_images`,"
				...
				." `allow_contact_by_pms`, `show_rss` ,`nbcats` ,`show_new`,`nbdays_new`,`show_hot`,`nbhits`,`bannedwords`,`replaceword`,`after_expiration`,`archive_catid`,`metadata_mode`,`params`) VALUES "
                ...
                ."  '{\"dlid\":\"\",\"email_admin\":\"\",\"name_admin\":\"\",\"crontype\":\"cron\",\"preview_ads\":\"0\",\"update_validation\":\"0\",\"publication_date\":\"0\",\"print\":\"0\",\"show_accept_rules\":\"0\",\"redirect_after_save\":\"default\",\"redirect_custom_link\":\"\\/\",\"globalfilter_fieldname\":\"\\/\",\"globalfilter_user\":\"1\",\"single_category_selection_type\":\"normal\",\"single_category_display_label\":\"0\",\"wizard_form\":\"0\",\"bootstrap_loading\":\"1\",\"display_column_date_date\":\"0\",\"display_column_date_user\":\"0\",\"display_column_date_view\":\"0\",\"display_column_date\":\"0\",\"display_nb_categories_per_row\":\"3\",\"display_nb_ads_per_categories\":\"0\",\"display_category_list_label\":\"0\",\"email_moderation\":\"0\",\"email_sender\":\"website\",\"copy_to_admin\":\"0\",\"email_on_waiting_validation\":\"0\",\"admin_waiting_validation_subject\":\"\",\"admin_waiting_validation_text\":\"\",\"send_email_waiting_validation_to_user\":\"0\",\"number_allow_attachement\":\"1\",\"max_width_m\":\"\\/\",\"max_height_m\":\"\\/\",\"image_scaling\":\"0\",\"medium_image_scaling\":\"0\",\"large_image_scaling\":\"0\",\"disclaimer_message\":\"\",\"favorite_enabled\":\"0\",\"favorite_display\":\"all\",\"map_display_all_ads\":\"0\",\"display_map_list\":\"0\",\"map_field\":\"ad_gmap\",\"map_hide\":\"0\",\"map_link_ads\":\"0\",\"map_display_title\":\"0\",\"map_enable_link_title\":\"0\",\"map_display_image\":\"0\",\"map_display_description\":\"0\",\"map_display_price\":\"0\",\"map_field_price\":\"ad_price\",\"map_height\":\"400\",\"map_default_lat\":\"48.85719913498834\",\"map_default_lng\":\"2.33935546875\",\"map_default_zoom\":\"6\"}')");
	...
	while($continue) {
		...
		switch($config->version) {
			...
			case 17:
				$queries = array();
				$queries[] = "CREATE TABLE IF NOT EXISTS `#__adsmanager_emailtemplates` (
				...
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'adsmanager_new_content', '{sitename} :  Your ad has been added', 'Hello, \nYour ad: {ad_headline} has been added. \n{link} \n{sitename}',
				 '*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'adsmanager_content_waiting_validation', '{sitename} : Your ad is pending validation', 
				'Hello, \nYour ad : {ad_headline} is pending validation. \n{link} \n{sitename}',
				 '*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'adsmanager_update_content', '{sitename} : Your ad has been modified', 'Hello, \nYour ad : {ad_headline} has been modified. \n{link} \n{sitename}',
				 '*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'admin_adsmanager_new_content', '{sitename} : New ad #{id}: {ad_headline}', '{sitename} : New ad #{id}: {ad_headline} \n{link} \n{ad_text}',
				 '*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'admin_adsmanager_content_waiting_validation', '{sitename} : New ad #{id}: {ad_headline} pending validation', '{sitename} : New ad #{id}: {ad_headline} pending validation \n{link} \n{ad_text}',
				 '*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'admin_adsmanager_update_content', '{sitename} : ad#{id} modified: {ad_headline}', '{sitename} : ad#{id} modified: {ad_headline} \n{link} \n{ad_text}',
				 '*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";						 
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'adsmanager_content_validated', '{sitename} : Your ad has been validated', 'Hello, \nYour ad : {ad_headline} has been validated. \n{link} \n{sitename}',
				 '*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";		
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'adsmanager_content_expiration', '{sitename} : Your ad will expire soon', 'Hello, \nYour ad : {ad_headline} will expire on {expiration_date}. \nTo renew it click on the following link: \n{expiration_link} \n{sitename}',
				 '*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";	
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'adsmanager_content_expired', '{sitename} : Your ad has expired', 'Hello, \nYour ad : {ad_headline} has expired. \nTo renew it click on the following link: \n{expiration_link} \n{sitename}',
				 '*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";							 						 				 
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'adsmanager_content_alert', '{sitename} :  New alert', 
				'Hello, \nAn ad corresponding to one of your alert criteria has just been posted. \nYou can find it here : \n{link} \n{sitename}',
				'*', '1', '0', current_timestamp(), '0', NULL, '0', NULL, '0');";
				$queries[] = "INSERT INTO `#__adsmanager_emailtemplates` (`id`, `key`, `subject`, `body`, `language`, `published`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES (NULL, 'adsmanager_content_alerts_list', '{sitename} - {cpt_ads} new ads posted since your last visit', 
			...
			case 15:
				...
				$queries[] = "ALTER TABLE `#__adsmanager_positions` ADD COLUMN type VARCHAR(50) DEFAULT 'details';";
				$queries[] = "INSERT IGNORE INTO `#__adsmanager_positions` (`id`, `name`, `title`, `type`) VALUES (NULL, 'editform-1', 'ADSMANAGER_EDIT_FORM_POSITION1', 'edit')";
				$queries[] = "INSERT IGNORE INTO `#__adsmanager_positions` (`id`, `name`, `title`, `type`) VALUES (NULL, 'editform-2', 'ADSMANAGER_EDIT_FORM_POSITION2', 'edit')";
				$queries[] = "INSERT IGNORE INTO `#__adsmanager_positions` (`id`, `name`, `title`, `type`) VALUES (NULL, 'editform-3', 'ADSMANAGER_EDIT_FORM_POSITION3', 'edit')";
				$queries[] = "INSERT IGNORE INTO `#__adsmanager_positions` (`id`, `name`, `title`, `type`) VALUES (NULL, 'editform-4', 'ADSMANAGER_EDIT_FORM_POSITION4', 'edit')";
			...
			case 9:
				$queries = array();
				$queries[] = "ALTER TABLE `#__adsmanager_categories` ADD `limitads` INT(11) default '-1';";
				$queries[] = "ALTER TABLE `#__adsmanager_ads` ADD `publication_date` DATETIME NOT NULL;";
				foreach($queries as $q) {
					$db->setQuery($q);
					try {
						$result = $db->query();
			...
			case 8:
				$queries = array();
				$queries[] = "ALTER TABLE `#__adsmanager_categories` ADD `limitads` INT(11) default '-1';";
				$queries[] = "ALTER TABLE `#__adsmanager_categories` ADD `usergroupsread` TEXT NOT NULL;";
				$queries[] = "ALTER TABLE `#__adsmanager_categories` ADD `usergroupswrite` TEXT NOT NULL;";
				foreach($queries as $q) {
					$db->setQuery($q);
					try {
						$result = $db->query();
			...
			case 7:
				...
				break;
			case 6:
				$q= "ALTER TABLE `#__adsmanager_categories` MODIFY `description` text;";
				$db->setQuery($q);
				try {
					$result = $db->query();
				} catch(Exception $e) {
			...
			case 5:
				...
				if ($count > 0) {
					...
					foreach($fields as $field) {
						$queries[] = "ALTER TABLE `#__adsmanager_ads` ADD `".$field->name."_lat` FLOAT default NULL;";
						$queries[] = "ALTER TABLE `#__adsmanager_ads` ADD `".$field->name."_lng` FLOAT default NULL;";
						$queries[] = "ALTER TABLE `#__adsmanager_ads` ADD `".$field->name."_zoom` int(10) unsigned default 8;";
						$queries[] = "ALTER TABLE `#__adsmanager_ads` ADD `".$field->name."_hide` int(1) unsigned default 0;";

						$queries[] = "ALTER TABLE `#__adsmanager_profile` ADD `".$field->name."_lat` FLOAT default NULL;";
						$queries[] = "ALTER TABLE `#__adsmanager_profile` ADD `".$field->name."_lng` FLOAT default NULL;";
						$queries[] = "ALTER TABLE `#__adsmanager_profile` ADD `".$field->name."_zoom` int(10) unsigned default 8;";
						$queries[] = "ALTER TABLE `#__adsmanager_profile` ADD `".$field->name."_hide` int(1) unsigned default 0;";

						//Patch for an old error in the update file (TEXT instead of FLOAT)
						$queries[] = "ALTER TABLE `#__adsmanager_ads` MODIFY `".$field->name."_lat` FLOAT default NULL;";
						$queries[] = "ALTER TABLE `#__adsmanager_ads` MODIFY `".$field->name."_lng` FLOAT default NULL;";
						$queries[] = "ALTER TABLE `#__adsmanager_ads` MODIFY `".$field->name."_zoom` int(10) unsigned default 8;";
						$queries[] = "ALTER TABLE `#__adsmanager_ads` MODIFY `".$field->name."_hide` int(1) unsigned default 0;";

						$queries[] = "ALTER TABLE `#__adsmanager_profile` MODIFY `".$field->name."_lat` FLOAT default NULL;";
						$queries[] = "ALTER TABLE `#__adsmanager_profile` MODIFY `".$field->name."_lng` FLOAT default NULL;";
						$queries[] = "ALTER TABLE `#__adsmanager_profile` MODIFY `".$field->name."_zoom` int(10) unsigned default 8;";
						$queries[] = "ALTER TABLE `#__adsmanager_profile` MODIFY `".$field->name."_hide` int(1) unsigned default 0;";
					}
			...
			case 4:
				...
				$db->setQuery(" ALTER TABLE `#__adsmanager_config` ADD `special` TEXT DEFAULT NULL;");
				try {
					$result = $db->query();
				} catch(Exception $e) {
				...
				break;
			case 3:
				$db->setQuery(" ALTER TABLE `#__adsmanager_config` ADD `params` TEXT DEFAULT NULL;");
				try {
					$result = $db->query();
				} catch(Exception $e) {
				...
				$db->setQuery(" ALTER TABLE `#__adsmanager_fields` ADD `options` TEXT DEFAULT NULL;");
				try {
					$result = $db->query();
				} catch(Exception $e) {
				...
				break;
			case 2:
				$db->setQuery("ALTER TABLE `#__adsmanager_ads` ADD `date_modified` DATETIME;");
				try {
					$result = $db->query();
				} catch(Exception $e) {
			...
			default:
				...
				if ($count > 0) {
					...
					foreach($fields as $field) {
						$query = "ALTER TABLE `#__adsmanager_ads` ADD `".$field->name."` TEXT default NULL;";
						$db->setQuery($query);
						try {
							$result = $db->query();
						} catch(Exception $e) {
