...
<table>
				<tr>
					...
					<td nowrap="nowrap">
                        ...
                        <span>
                            <input type="text" name="content_id" value="<?php echo ($this->content_id !== '' && $this->content_id !== "0") ? htmlspecialchars($this->content_id) : ''; ?>" class="text_area" onChange="document.adminForm.submit();" />
                        </span>
...
<?php
	...
	<td><?php echo $this->reorderDate1($content->date_created); ?></td>
	<td><?php echo $this->reorderDate2($content->expiration_date); ?></td>
	</tr>
<?php
	$k++;
	if ($k==2)
