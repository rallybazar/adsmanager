...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	...
	<?php } ?>
	<tr>
		<td><?php echo JText::_('ADSMANAGER_EMAIL_ADMIN_MODE'); ?></td>
		<td>
			<select id='email_admin_mode' name='params_email_admin_mode'>
				<option value='1' <?php if ($this->conf->email_admin_mode == 1) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_USERGROUPS'); ?></option>
				<option value='0' <?php if ($this->conf->email_admin_mode == 0) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_SINGLE_EMAIL'); ?></option>
			</select>
		</td>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		<td><?php echo JText::_('ADSMANAGER_EMAIL_ADMIN_USERGROUPS'); ?></td>
		<td>
			<?php
				echo JHTMLAdsmanagerUserGroups::getUserGroups('params_email_admin_usergroups[]', empty($this->conf->email_admin_usergroups) ? '-1' : $this->conf->email_admin_usergroups, array('id' => 'email_admin_usergroups[]','multiple' => 'multiple', 'size' => 10));
			?>
		</td>
		<td>&nbsp;</td>
	</tr>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	...
	*/
	...
	<tr>
		<td><?php echo JText::_('ADSMANAGER_CATEGORY_LEVEL_HOMEPAGE'); ?></td>
		<td>
			<input type="text" name="params_category_level_homepage" id="category_level_homepage" value="<?php echo @$this->conf->category_level_homepage; ?>" />
		</td>
		<td><?php echo JText::_('ADSMANAGER_CATEGORY_LEVEL_HOMEPAGE_LONG'); ?></td>
	</tr>
	<tr>
	...
	<tr>
            <td><?php echo JText::_('ADSMANAGER_DISPLAY_MAP_NAME_MODULE'); ?></td>
            <td>
                <input type="text" name="params_display_map_name_module" id="display_map_name_module" value="<?php echo @$this->conf->display_map_name_module; ?>" />
            </td>
            <td><?php echo JText::_('ADSMANAGER_DISPLAY_MAP_NAME_LIST_LONG'); ?></td>
        </tr>
	<tr>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	...
	<tr>
		...
		<select id='email_display' name='email_display'>
			...
			<option value='3' <?php if ($this->conf->email_display == 3) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_EMAIL_DISPLAY_FORM_DIRECT');?></option>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	...
	<tr>
		<td><?php echo JText::_('ADSMANAGER_IMAGE_DELETE_MODE'); ?></td>
		<td>
		<select id='deleteimagemode' name='params_deleteimagemode'>
			<option value='confirm' <?php if ($this->conf->deleteimagemode == 'confirm') { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_IMAGE_DELETE_MODE_CONFIRM'); ?></option>
			<option value='multiple' <?php if ($this->conf->deleteimagemode == 'multiple') { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_IMAGE_DELETE_MODE_MULTIPLE'); ?></option>
		</select>
		</td>
	...
	<tr>
		<td><?php echo JText::_('ADSMANAGER_DISPLAY_ROTATE_IMAGE'); ?></td>
		<td>
		<select id='display_rotate_image' name='params_display_rotate_image'>
			<option value='0' <?php if (@$this->conf->display_rotate_image == '0') { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_NO'); ?></option>
			<option value='1' <?php if (@$this->conf->display_rotate_image == '1') { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_YES'); ?></option>
		</select>
		</td>
		<td><?php echo JText::_('ADSMANAGER_DISPLAY_ROTATE_IMAGE_DESC'); ?></td>
	</tr>
</table>
<?php   
echo $tabs->endPanel();
		...
		<select id='disclaimer_categories' name='params_disclaimer_categories[]' multiple='multiple' size='5'>
            <?php
                foreach($this->listcats as $cat){
                    $selected = "";
                    if(is_array($this->conf->disclaimer_categories) && @in_array($cat->id,$this->conf->disclaimer_categories)) { 
                        $selected = "selected"; 
                    }
...
<?php
echo $tabs->endPanel();
echo $tabs->startPanel(JText::_('ADSMANAGER_TAB_ADVERTISING'), "advertising-page");
?>
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	<tr>
		<td><?php echo JText::_('ADSMANAGER_ADVERTISING_ENABLED'); ?></td>
		<td>
			<select id='advertising_enabled' name='params_advertising_enabled'>
				<option value='0' <?php if (@$this->conf->advertising_enabled == 0) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_NO'); ?></option>
				<option value='1' <?php if (@$this->conf->advertising_enabled == 1) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_YES'); ?></option>
		 	</select>
		</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td><?php echo JText::_('ADSMANAGER_ADVERTISING_CATEGORY_ID'); ?></td>
		<td>
		<input type="number" name="params_advertising_category_id" value="<?php echo @htmlspecialchars($this->conf->advertising_category_id); ?>" />
        </td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td><?php echo JText::_('ADSMANAGER_ADVERTISING_NUMBER_OF_ADS_BETWEEN_DISPLAY'); ?></td>
		<td>
		<input type="number" name="params_advertising_number_ads_between" value="<?php echo @htmlspecialchars($this->conf->advertising_number_ads_between); ?>" />
        </td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td><?php echo JText::_('ADSMANAGER_ADVERTISING_DISPLAY_ALL_DATAS_AFTER_ADS'); ?></td>
		<td>
			<select id='advertising_display_all_banners_after_ads' name='params_advertising_display_all_banners_after_ads'>
				<option value='0' <?php if (@$this->conf->advertising_display_all_banners_after_ads == 0) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_NO'); ?></option>
				<option value='1' <?php if (@$this->conf->advertising_display_all_banners_after_ads == 1) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_YES'); ?></option>
		 	</select>
        </td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td><?php echo JText::_('ADSMANAGER_ADVERTISING_BANNERS_ORDER'); ?></td>
		<td>
			<select id='advertising_banners_orders' name='params_advertising_banners_orders'>
				<option	value="0" <?php if (@$this->conf->advertising_banners_orders == 0) { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_BRUCE_VALUE_STICKYORDERING'); ?></option>
				<option	value="random" <?php if (@$this->conf->advertising_banners_orders == 'random') { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_BRUCE_VALUE_STICKYRANDOMISE'); ?></option>
				<option	value="last_publish_up" <?php if (@$this->conf->advertising_banners_orders == 'last_publish_up') { echo "selected"; } ?>><?php echo JText::_('ADSMANAGER_BRUCE_VALUE_STICKYLASTPUBLISHUP'); ?></option>
			</select>
        </td>
		<td>&nbsp;</td>
	</tr>
