        ...
        <div class="adsmanager-grid<?php echo $classcontent; ?>">
            ...
            <div class="text-center fad-image">
                ...
                if (isset($content->images[0])) {
                    echo "<a href='".$linkTarget."'><img name='adimage".$content->id."' src='".JURI_IMAGES_FOLDER."/".$content->images[0]->image."?".filemtime(JPATH_IMAGES_FOLDER."/".$content->images[0]->image)."' alt=\"".htmlspecialchars($content->ad_headline)."\" /></a>";
