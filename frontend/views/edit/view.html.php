...
class AdsmanagerViewEdit extends TView
{
	function display($tpl = null)
	{
		...
		if (isset($content))
			// $document->setTitle( JText::_('ADSMANAGER_PAGE_TITLE_EDIT')." ".$content->ad_headline);
			$document->setTitle( JText::_('ADSMANAGER_PAGE_TITLE_EDIT'));
		else
			$document->setTitle( JText::_('ADSMANAGER_PAGE_TITLE_CREATE'));
