            ...
            <fieldset>
                ...
                <div id="adshome" class="row-fluid">
                    ...
                    foreach ($this->cats as $row) {
                        ...
                        if(isset($this->conf->category_level_homepage) && $this->conf->category_level_homepage >= 0) {
                            if ($row->level > (int)$this->conf->category_level_homepage) {
                                continue;
                            }
                        } else {
                            if ($row->level > 1) {
                        ...
                        if ($row->level == 0) {
                            ...
                            echo ' - <a href="'.$link.'">'.htmlspecialchars($row->name).$numAds.'</a><br />';
                        }
                    }
                    if ($divopen == true) {
                        ?>
