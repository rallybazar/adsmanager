...
require_once(JPATH_BASE.'/administrator/components/com_adsmanager/models/alert.php');
 ...
 * @subpackage	Contacts
 */
class AdsmanagerViewAlert extends TView
{
	function display($tpl = null)
	{
		...
		if ($alertid != 0) {
			...
			$defaultvalues = $alert->fields; 
			$catid = $alert->catid;
			$text_search = $alert->tsearch;
		} else {
