...
if(!defined('JPATH_FILES_FOLDER')){
	define('JPATH_FILES_FOLDER',JPATH_ROOT."/images/com_adsmanager/files");
}
if(!defined('JURI_FILES_FOLDER')){
	define('JURI_FILES_FOLDER',JURI::root()."images/com_adsmanager/files");
}
...
require_once(JPATH_ROOT.'/components/com_adsmanager/lib/phpcompat.php');
require_once(JPATH_ROOT.'/components/com_adsmanager/lib/route.php');
require_once(JPATH_ROOT.'/components/com_adsmanager/lib/pagination.php');
require_once(JPATH_ROOT.'/components/com_adsmanager/lib/tools.php');
require_once(JPATH_ROOT.'/components/com_adsmanager/lib/pane.php');
require_once(JPATH_ROOT.'/components/com_adsmanager/lib/mail.php');
require_once(JPATH_ROOT.'/components/com_adsmanager/lib/tconf.php');
require_once(JPATH_ROOT.'/components/com_adsmanager/lib/link.php');


require_once(JPATH_ROOT.'/components/com_adsmanager/lib/cron.php');


if(version_compare(JVERSION, '1.6', 'ge')) {
    require_once(JPATH_ROOT.'/components/com_adsmanager/lib/tpermissions.php');
}
require_once(JPATH_ROOT.'/components/com_adsmanager/lib/ttext.php');
