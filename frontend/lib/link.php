...
class TLink {
	...
	static function getProfileLink()
	{
		if (COMMUNITY_BUILDER == 1) {
			...
			include_once JPATH_ROOT.'/components/com_community/libraries/core.php';
			// Get CUser object
			$link = TRoute::_('index.php?option=com_community&view=profile&task=edit');
			return $link;
		} else {
	...
	static function getMyAdsLink()
	{
		if (COMMUNITY_BUILDER_ADSTAB == 1)
			...
			include_once JPATH_ROOT.'/components/com_community/libraries/core.php';
			// Get CUser object
			$link = TRoute::_('index.php?option=com_community&view=profile');
			return $link;
		}
		else
	...
	static function getUserAdsLink($userid)
	{
		if (COMMUNITY_BUILDER_ADSTAB == 1)
			...
			include_once JPATH_ROOT.'/components/com_community/libraries/core.php';
			// Get CUser object
			$link = TRoute::_('index.php?option=com_community&view=profile&userid='.$userid);
			return $link;
		}
		else
