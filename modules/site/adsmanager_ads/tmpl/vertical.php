    ...
    ?>
        ...
        ?>
            ...
            if (isset($row->images[0])) {
                echo "<div class='text-center'><a href='".$linkTarget."'><img src='".JURI_IMAGES_FOLDER."/".$row->images[0]->$imagetype."?".filemtime(JPATH_IMAGES_FOLDER."/".$row->images[0]->$imagetype)."' alt=\"".htmlspecialchars($row->ad_headline)."\" border='0' /></a></div>";
            }
            else
            {
