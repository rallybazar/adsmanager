...
$search_by_cat = $params->get('search_by_cat',1);
$display_cat_label = $params->get('display_cat_label',0);
$search_by_text = $params->get('search_by_text',1);


$rootid = (int)$params->get( 'rootid', 0) ;
...
require(JModuleHelper::getLayoutPath('mod_adsmanager_advancedsearch',$params->get( 'layout','default')));
